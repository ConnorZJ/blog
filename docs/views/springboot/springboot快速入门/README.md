...
![image](http://qiniuyun.zijie.fun/springboot-io.png)
...
![image](http://qiniuyun.zijie.fun/idea1.png)
点击next就到下一步，输入项目的元数据
![image](http://qiniuyun.zijie.fun/idea2.png)
再点击next，就到了选择依赖的地方，还能选择spring boot的版本号，之后再finish
![image](http://qiniuyun.zijie.fun/idea3.png)
...
![image](http://qiniuyun.zijie.fun/spring-boot-1.png)
在浏览器上输入localhost:8080/hello，就可以看到在HelloController中方法返回的字符串了。
![image](http://qiniuyun.zijie.fun/spring-boot-2.png)